          ...
          <div className="container mx-auto px-6 pb-20 relative z-10">
            <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
              <div className="card-luxury rounded-3xl p-10">
                ...
                <div className="heading-font text-4xl gradient-text mb-2">$29</div>
              ...
              <div className="card-luxury rounded-3xl p-10">
                ...
                <div className="heading-font text-4xl gradient-text mb-2">$49</div>
              ...
              <div className="card-luxury rounded-3xl p-12 text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center justify-center gap-4 mb-8">
                    <div className="text-3xl text-gray-500 line-through">$78</div>
          ...
          <div className="max-w-5xl w-full">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="card-luxury rounded-3xl p-8 cursor-pointer" onClick={() => {
                ...
                <div className="heading-font text-4xl gradient-text mb-4">$29</div>
              ...
              <div className="card-luxury rounded-3xl p-8 cursor-pointer" onClick={() => {
                ...
                <div className="heading-font text-4xl gradient-text mb-4">$49</div>
                <ul className="space-y-2 text-sm text-gray-300">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400" />
                    8 Custom Questions
              ...
              <div className="card-luxury rounded-3xl p-8 cursor-pointer border-2 border-yellow-500/50" onClick={() => {
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="px-3 py-1 bg-yellow-500/20 text-yellow-300 text-xs font-bold rounded-full">SAVE $48</span>
                </div>
                <h3 className="heading-font text-2xl mb-2">Complete Bundle</h3>
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-xl text-gray-500 line-through">$78</span>
        ...
        <div className="min-h-screen py-20 px-6 relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="card-luxury rounded-3xl p-12 text-center border-2 border-purple-500/50">
              ...
              <div className="heading-font text-7xl gradient-text mb-8">${selectedProduct === 'bundle' ? '30' : '29'}</div>
              <button 
              ...
              {selectedProduct !== 'bundle' && (
                <div className="mt-6">
                  ...
                  >
                    Upgrade to Bundle for Just $1 More!
                  </button>
                </div>
              )}
            </div>
        ...
        <div className="min-h-screen flex items-center justify-center px-6 relative z-10">
          <div className="max-w-2xl w-full">
            <div className="card-luxury rounded-3xl p-12">
              ...
              >
                {selectedProduct === 'interview' ? 'Pay $49 & Start Practice' : 'Start Interview Practice'}
              </button>
            </div>
          </div>
        </div>
